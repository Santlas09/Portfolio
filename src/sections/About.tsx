    ...
    <section id="about" className="bg-slate-900 px-6 py-24 text-white">
      <SectionWrapper className="mx-auto max-w-6xl">
        ...
        <h2 className="text-3xl font-bold md:text-4xl">
          A developer focused on practical and scalable solutions.
        </h2>

        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
          I am an eighth-semester Systems and Computing Engineering student
          with experience in web and mobile application development. I enjoy
